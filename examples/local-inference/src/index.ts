 ...
 * exists so the tests here — and a topology runner beside them — can start the same processes in
 * one line. It depends on the published `@agora/sdk` and nothing else in this repo, and nothing
